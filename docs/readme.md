...
Welcome to the Grain project docs. This directory is the source of truth for product, architecture, and delivery guidance.
...
ADRs track significant technical decisions and rationale. See [adr/README.md](adr/README.md).
